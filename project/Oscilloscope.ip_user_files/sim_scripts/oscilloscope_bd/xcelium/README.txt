...
#
# Generated by export_simulation on Sun Nov 27 14:07:08 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './oscilloscope_bd.sh' script.

./oscilloscope_bd.sh -reset_run
...
./oscilloscope_bd.sh -noclean_files

For more information on the script, please type './oscilloscope_bd.sh -help'.
